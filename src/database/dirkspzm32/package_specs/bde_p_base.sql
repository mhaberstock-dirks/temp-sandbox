...
package DIRKSPZM32.bde_p_base is
  ...
  */
  ...
  function get_fa_kopf(in_sid          in  bde_fa_kopf.sid%type,
                       ...
                       out_bde_fa_kopf out bde_fa_kopf%rowtype) return boolean;
  ...
  function get_fa_ag(in_sid        in  bde_fa_auftrag.sid%type,
                     ...
                     out_bde_fa_ag out bde_fa_auftrag%rowtype) return boolean;
  ...
  function get_bde_pd_prozess_data(in_sid                          in  bde_pd_prozess_data.sid%type,
                                   ...
                                   out_bde_pd_prozess_data         out bde_pd_prozess_data%rowtype) return boolean;
