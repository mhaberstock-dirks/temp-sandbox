  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PZM_V_KONTEN_SALDEN_3MONATE" ("PERS_NR", "NAME", "NAME_KURZ", "KONTO_NR", "MONAT_DATUM", "SALDO_MONAT_START", "SALDO_MONAT_ENDE", "AKT_SALDO", "INFO_WERT_MONAT_DIFF", "INFO_SALDO_MONAT_DIFF") AS 
  select t.pers_nr,
       t.name,
       t.name_kurz,
       t.konto_nr,
...
-- sqlcl_snapshot {"hash":"570ea6b1e2b87a61b04a81adbc7fd189b3bcb65c","type":"VIEW","name":"PZM_V_KONTEN_SALDEN_3MONATE","schemaName":"DIRKSPZM32","sxml":""}