create or replace editionable trigger dirkspzm32.tr_isi_kpi_cfg_biud before
    insert or update on dirkspzm32.isi_kpi_cfg
    for each row
declare
...
-- sqlcl_snapshot {"hash":"323c1f896e6e6cec3cc3cce770d83f311f6276d5","type":"TRIGGER","name":"TR_ISI_KPI_CFG_BIUD","schemaName":"DIRKSPZM32","sxml":""}