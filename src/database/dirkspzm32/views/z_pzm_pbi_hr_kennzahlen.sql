  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "Z_PZM_PBI_HR_KENNZAHLEN" ("BU_ID", "BU_NAME", "LNR", "JAHR", "MONAT", "NAME", "VORNAME", "PLNR", "PERSONALNUMMER", "KSTNR", "KST_NAME", "ABTEILUNG", "EINTRITT", "AUSTRITT", "GEBURTSDATUM", "ZEITSALDO", "URLAUBSALDO", "LAST_CHANGE_DATE") AS 
  select   b.bu_id,
         b.bu_name,
         'ZEIT' ||
         to_char(p.pers_nr) ||
...
-- sqlcl_snapshot {"hash":"601186ab533224c5272545b1db2d50cea6942b15","type":"VIEW","name":"Z_PZM_PBI_HR_KENNZAHLEN","schemaName":"DIRKSPZM32","sxml":""}