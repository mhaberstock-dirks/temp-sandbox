create or replace editionable trigger dirkspzm32.tr_sas_isi_recource_aiu after
    insert or update or delete on dirkspzm32.isi_resource
    for each row
declare
  ...
  -- Erst mal kein Fehler
    ...
    if not deleting then
        begin
            ...
            insert into fls_element_cfg values ( :new.sid,                 -- sid
                                                 :new.firma_nr,            -- firma
                                                 1,                        -- INSTANCE_ID
                                                 1,                        -- RESET_GRUPPEN_ID
        ...
        exception
            when others then
                ...
                set
                    f.element_typ = :new.kategorie_typ,      -- ELEMENT_TYP
...
-- sqlcl_snapshot {"hash":"5323dd03d10a455206a80ff428d2cc9c356c8c74","type":"TRIGGER","name":"TR_SAS_ISI_RECOURCE_AIU","schemaName":"DIRKSPZM32","sxml":""}