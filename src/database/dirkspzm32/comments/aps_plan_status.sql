comment on table APS_PLAN_STATUS is 'Status der Planung (APS)';
comment on column APS_PLAN_STATUS."AEND_DATUM" is 'Bearbeitungsdatum, zuletzt bearbeitet am';
comment on column APS_PLAN_STATUS."AEND_LOGIN_ID" is 'ID des Bearbeiters';
comment on column APS_PLAN_STATUS."APS_COMMAND" is 'StartAuto = Startet die zyklische Verarbeitung.
...
comment on column APS_PLAN_STATUS."APS_INTERVAL_SEC" is 'Interval in Sekunden beim Start aus der FIRMA_CFG übernommen';
comment on column APS_PLAN_STATUS."APS_MODE" is '0 = Kein Automatikmodus, 1 = Automatikmodus ist eingeschaltet';
comment on column APS_PLAN_STATUS."APS_STATUS" is 'Typ der Aktion:
PS = Start Planung,
...
comment on column APS_PLAN_STATUS."ERZ_DATUM" is 'Erstellungsdatum, erstellt am';
comment on column APS_PLAN_STATUS."ERZ_LOGIN_ID" is 'ID des Erstellers';
comment on column APS_PLAN_STATUS."FIRMA_NR" is 'Firmennummer in der Datenbank';
comment on column APS_PLAN_STATUS."INFO_DEBUG" is 'internes Informationsfeld';
comment on column APS_PLAN_STATUS."MESSAGE_CODE" is 'Message Return Code';
comment on column APS_PLAN_STATUS."MESSAGE_TEXT" is 'Message text';
comment on column APS_PLAN_STATUS."PLAN_STATUS" is 'Canceled = Die Aufgabe hat den Abbruch durch Auslösen einer OperationCanceledException mit einem eigenenCancellationToken bestätigt, während das Token im Zustand „signalisiert“ war, oder das CancellationToken der Aufgabe wurde bereits vor dem Start der Aufgabenausführung signalisiert.
...
comment on column APS_PLAN_STATUS."PLAN_TS_END" is 'Zeitpunkt der Aktion Ende';
comment on column APS_PLAN_STATUS."PLAN_TS_START" is 'Zeitpunkt der Aktion START';
comment on column APS_PLAN_STATUS."SID" is 'Datenbank für Konsolidierung';



-- sqlcl_snapshot {"hash":"02434bc97578f1bda05265f8cb1e1874b08125d8","type":"COMMENT","name":"aps_plan_status","schemaName":"dirkspzm32","sxml":""}