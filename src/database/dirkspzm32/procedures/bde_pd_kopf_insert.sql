create or replace procedure dirkspzm32.bde_pd_kopf_insert
/*
...
begin
    ...
    insert into bde_pd_kopf values ( in_sid,
                                     in_firma_nr,
                                     in_res_id,
                                     null,
                                     in_sysdate,
...
-- sqlcl_snapshot {"hash":"1476573fe83ac3f17e59f776c8177b9cec71360d","type":"PROCEDURE","name":"BDE_PD_KOPF_INSERT","schemaName":"DIRKSPZM32","sxml":""}