create or replace package body dirkspzm32.global_p_session_log is
  -----------------------------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------------------------
    ...
    type t_buffer is
        table of t_buffer_entry index by pls_integer;
    g_buffer         t_buffer;
  ...
  -----------------------------------------------------------------------------------------------
    ...
    begin
        open p_cursor for select
                              ...
                              ctx_date1
                          from
                              table ( get_entries(p_clear_buffer) );
...
-- sqlcl_snapshot {"hash":"4c6cc9e268655eeb3eff1710bd714da706bdb810","type":"PACKAGE_BODY","name":"GLOBAL_P_SESSION_LOG","schemaName":"DIRKSPZM32","sxml":""}