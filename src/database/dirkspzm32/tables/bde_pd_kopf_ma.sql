create table dirkspzm32.bde_pd_kopf_ma (
    ...
    pd_kopf_beginn       date not null enable,
    pd_kopf_ende         date,
    res_kst              varchar2(15 char),
    pers_kst             number(*, 5),
...
alter table dirkspzm32.bde_pd_kopf_ma
    add constraint pk_bde_pd_kopf_ma
        primary key ( sid,
                      firma_nr,
                      res_id,
                      pd_kopf_beginn )
