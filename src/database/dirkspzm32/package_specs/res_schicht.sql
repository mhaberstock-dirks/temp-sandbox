...
procedure c_loesche_isi_res_schicht(in_schicht_id in isi_res_schicht.schicht_id%type
);
...
function check_schicht_vorhanden(in_start_date in date,
                                   in_end_date in date,
                                   in_isi_res_id in isi_resource.res_id%type) return boolean
;


function differenz_nur_zeit_in_sekunden(in_start_zeit date,
                                    in_ende_zeit date)  return integer
;
