create or replace package body dirkspzm32.dw_bde_funktionen is
    ...
    procedure dw_bde_kenz_tagesab (
        ...
        select
            ...
            nvl((
                select
                    sum(pdx.menge_a + nvl(pdx.menge_b, 0) + nvl(pdx.schrott, 0))
                from
                    bde_pd_prod pdx
                where
                        r.res_id = pdx.res_id
    ...
    begin
        ...
        isi_p_log.c_isi_system_meldung(in_sid,
                                       ...
                                       null,
                                       'gestartet für '
                                       || to_char(in_start, 'yyyy-mm-dd hh24')
                                       || ' bis '
                                       || to_char(in_ende, 'yyyy-mm-dd hh24'),
                                       'IL');

        while v_ende <= in_ende loop
        ...
        isi_p_log.c_isi_system_meldung(in_sid, in_firma_nr, 'BDE_DW_T-AB_JOB', 'ORA-DB', 'dw_bde_funktionen.dw_bde_kenz_tagesab',
  ...
  -- Function and procedure implementations
    ...
    -- Test statements here
        ...
        loop
            ...
            loop
                ...
                v_ende := v_start + ( 1 / 24 );
                v_dw_bde.dw_bde_auftragswechsel := bde_funktionen.get_res_auf_wechsel(v_res.res_id, v_start, v_ende);
                v_dw_bde.dw_bde_menge_gut := bde_funktionen.get_bde_gut_mengen(v_res.res_id, null, v_start, v_ende);
                ...
                v_dw_bde.dw_bde_prod_minuten := bde_funktionen.get_res_prod_std(v_res.res_id, v_start, v_ende) * 60;
                ...
                v_dw_bde.dw_bde_anmelde_miniten := v_dw_bde.dw_bde_prod_minuten + v_dw_bde.dw_bde_ruest_minuten + v_dw_bde.dw_bde_stoer_minuten
                ;
                begin
                    insert into dw_bde_prod_daten t values ( v_res.sid,                       -- SID                    VARCHAR2(2) not null,
                ...
                exception
                    when others then
                        ...
                        set
                            t.dw_bde_auftragswechsel = v_dw_bde.dw_bde_auftragswechsel, -- DW_BDE_AUFTRAGSWECHSEL NUMBER,
                        ...
                        where
                                t.sid = v_res.sid                       -- SID                    VARCHAR2(2) not null,
    ...
    begin
        ...
        loop
            ...
            if
                ( v_dw_bde_daten.dw_bde_datum_start - trunc(v_dw_bde_daten.dw_bde_datum_ende) <= 14 / 24 )
            ...
            then
                ...
                ( v_dw_bde_daten.dw_bde_datum_start - trunc(v_dw_bde_daten.dw_bde_datum_ende) <= 22 / 24 )
...
-- sqlcl_snapshot {"hash":"0477e1e4ceb17864f54de69528986284feb8a4e9","type":"PACKAGE_BODY","name":"DW_BDE_FUNKTIONEN","schemaName":"DIRKSPZM32","sxml":""}