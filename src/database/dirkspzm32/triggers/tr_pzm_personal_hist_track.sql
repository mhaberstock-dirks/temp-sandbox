create or replace editionable trigger dirkspzm32.tr_pzm_personal_hist_track before
...
declare
 ...
 begin
    ...
    or (
        :new.pers_urlaub_anspr_wert != :old.pers_urlaub_anspr_wert
        and :new.pers_urlaub_anspr_aa_id = :old.pers_urlaub_anspr_aa_id
    )
    or :new.pers_urlaub_anspr_aa_id != :old.pers_urlaub_anspr_aa_id
    or :new.pers_startdatum != :old.pers_startdatum
    or :new.tarif_name != :old.tarif_name then
...
-- sqlcl_snapshot {"hash":"10c3353fc6ed3132e52daa0992c42d470dab8373","type":"TRIGGER","name":"TR_PZM_PERSONAL_HIST_TRACK","schemaName":"DIRKSPZM32","sxml":""}