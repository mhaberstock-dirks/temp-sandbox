create or replace procedure dirkspzm32.bde_pd_lte_fertig
/*
...
begin
    ...
    where
        ...
        and res.lte_id = in_lte_id;

    commit;
    if
        in_drucker is not null -- -AG- Drucker ist übergeben und vorhanden
...
-- sqlcl_snapshot {"hash":"55b373889db006a09e67b8b81da90281558d5c43","type":"PROCEDURE","name":"BDE_PD_LTE_FERTIG","schemaName":"DIRKSPZM32","sxml":""}