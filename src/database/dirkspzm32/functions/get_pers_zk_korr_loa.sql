create or replace 
function GET_PERS_ZK_KORR_LOA(in_pers_nr in pzm_personal.pers_nr%type
                                                ) return varchar2 is
...
-- sqlcl_snapshot {"hash":"1639909fcf4e9a8ab2bcebb3eb89855962b6eb38","type":"FUNCTION","name":"GET_PERS_ZK_KORR_LOA","schemaName":"DIRKSPZM32","sxml":""}