  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TR_PZM_ZE_TAGESSATZ_BDE_ZEITEN_AU" 
  after update
  on PZM_ZE_TAGESSATZ
  for each row
...
/
ALTER TRIGGER "TR_PZM_ZE_TAGESSATZ_BDE_ZEITEN_AU" ENABLE;


-- sqlcl_snapshot {"hash":"59b836b58adcc550e79dfb795a21ee1cece8779b","type":"TRIGGER","name":"TR_PZM_ZE_TAGESSATZ_BDE_ZEITEN_AU","schemaName":"DIRKSPZM32","sxml":""}