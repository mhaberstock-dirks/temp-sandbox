create or replace package body dirkspzm32.res_status is
	-------------------------------------------------------------------------------------------------------
    ...
    begin
      ...
      /* ggf. offenen Status schliessen */
            ...
            insert into isi_res_status values ( in_sid,
                                                in_firma_nr,
                                                in_res_id,
                                                v_sysdate,
                                                null,
        ...
        set
            res_akt.status_id = in_res_st_id,
    ...
    begin
        ...
        open c_res_status;
        fetch c_res_status into v_res_status;
        if c_res_status%found then
            res_status_beg(in_sid, in_firma_nr, in_res_id,
             ...
             v_res_status.ls_login_id, v_res_status.res_st_id,
                           v_res_status.res_typ, v_res_status.res_st_ug_id, v_res_status.fehler_res_id, v_sysdate);
        end if;
    ...
    begin
        res_status_beg(in_sid, in_firma_nr, in_res_id, in_ls_login_id, in_res_st_id,
                       in_res_typ, in_res_st_ug_id, in_fehler_res_id, in_sysdate);
    ...
    begin
        res_status_unterb(in_sid, in_firma_nr, in_res_id, in_ls_login_id, in_sysdate);
        commit;
    end;
    ...
    begin
        res_status_grund(in_sid, in_firma_nr, in_res_id, in_ls_login_id, in_res_st_id,
                         in_res_typ, in_res_st_ug_id, in_fehler_res_id);
  ...
  -- Stücklistenreferenz gebucht.
    ...
    begin
        ...
        or v_res_zust_akt.status_id is null then
            res_status_beg(in_sid, in_firma_nr, in_res_id, in_ls_login_id, in_res_st_id,
                           in_res_typ, in_res_st_ug_id, in_fehler_res_id, in_sysdate);
        ...
        then
            if in_res_st_id = 0 then
                ...
                if v_pd_lam_stl_daten.stl_lam_ab_menge is not null then
                    update bde_pd_lam_stl_daten t
                    set
                        t.res_status_id = in_res_st_id
                    where
                        t.pd_lam_stl_daten_id = v_pd_lam_stl_daten.pd_lam_stl_daten_id;
...
-- sqlcl_snapshot {"hash":"330aaf1289407e4c87266b24367736217fcebd50","type":"PACKAGE_BODY","name":"RES_STATUS","schemaName":"DIRKSPZM32","sxml":""}