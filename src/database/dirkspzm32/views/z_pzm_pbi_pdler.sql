  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "Z_PZM_PBI_PDLER" ("BU_ID", "BU_NAME", "LNR", "DATUM", "FIRMA", "PLNR", "PERSONALNUMMER", "NNAME", "VNAME", "KSTNR", "LOHNART", "LOHNARTTEXT", "STUNDEN", "KST_ANTEIL", "VERRECHNUNGSSATZ", "GOR", "LAST_CHANGE_DATE") AS 
  select b.bu_id,
       b.bu_name,
       'PDL' ||
       to_char(pdl.pers_nr) ||
...
-- sqlcl_snapshot {"hash":"09c64074c5cffc9a8db6ec45146243bc1ff1145d","type":"VIEW","name":"Z_PZM_PBI_PDLER","schemaName":"DIRKSPZM32","sxml":""}