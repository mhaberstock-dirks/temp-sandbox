create or replace procedure dirkspzm32.mb_crt_lgr_fuer_res is
...
begin
    ...
    loop
        ...
        begin
            insert into lvs_lgr values ( v_res.sid,
                                         v_res.firma_nr,
                                         v_res.res_ext_name,
                                         v_res.res_ext_name,
                                         ...
                                         2,
                                         1,
                                         to_number(lpad(1, 4, '0')
                                                   || lpad(1, 4, '0')
                                                   || lpad(v_res.res_name, 4, '0')
        ...
        set
            r.lager_roh = '1.' || v_res.res_name,
            r.lager_fertig = v_res.res_ext_name
        where
            r.res_id = v_res.res_id;
...
-- sqlcl_snapshot {"hash":"0ff182ec6048408702cdac8580b6cd5326a17b59","type":"PROCEDURE","name":"MB_CRT_LGR_FUER_RES","schemaName":"DIRKSPZM32","sxml":""}