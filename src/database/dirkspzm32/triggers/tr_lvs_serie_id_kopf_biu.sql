  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "DIRKSPZM32"."TR_LVS_SERIE_ID_KOPF_BIU" 
  before insert or update on DIRKSPZM32.LVS_SERIE_ID_KOPF
  for each row
begin
...
-- sqlcl_snapshot {"hash":"884d5af53a6be70fa4f318db87c2638377ee8d21","type":"TRIGGER","name":"TR_LVS_SERIE_ID_KOPF_BIU","schemaName":"DIRKSPZM32","sxml":""}