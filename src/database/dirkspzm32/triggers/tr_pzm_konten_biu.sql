  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TR_PZM_KONTEN_BIU" 
BEFORE INSERT OR UPDATE ON PZM_KONTEN FOR EACH ROW
begin
  if inserting
  then
...
/
ALTER TRIGGER "TR_PZM_KONTEN_BIU" ENABLE;


-- sqlcl_snapshot {"hash":"c6c77461102c00799b1b5849abe077e12261e4cf","type":"TRIGGER","name":"TR_PZM_KONTEN_BIU","schemaName":"DIRKSPZM32","sxml":""}