...
declare
  ...
  cursor c_mde_statistik is
    select ms.*
      from mde_statistik ms
     where ms.leitzahl = :new.leitzahl
  ...
  CURSOR c_mde_cfg is
    select *
      from mde_cfg cfg
     where cfg.res_id   = v_res_zust_akt.res_id;
...
begin
  ...
  v_merk_leitzahl := nvl(:new.leitzahl, -1);
  ...
  if :new.leitzahl > 0 then
    ...
    then
      ...
      if :new.delta_zaehler_2 < 0
      or :new.delta_zaehler_2 > :new.delta_zaehler_3 * 2
      then
        :new.delta_zaehler_2 := :new.delta_zaehler_3;
      else
        if  :new.zaehler_2 = :new.delta_zaehler_2
  ...
  or nvl(v_res_zust_akt.leitzahl, 0) > 0
  then
    OPEN c_fa_auftrag;
    FETCH c_fa_auftrag into v_fa_auftrag;
    CLOSE c_fa_auftrag;

    if nvl(v_res_zust_akt.leitzahl, 0) != 0
    and v_fa_auftrag.anz_res = 1
    then
      update bde_fa_auftrag t
         set t.mde_ist_mg = :new.zaehler_2,
             t.mde_ist_mg_t = :new.zaehler_3
       where t.sid = v_res_zust_akt.sid
  ...
  if c.C_TRUE =
     isi_allg.get_firma_cfg_param(:new.sid,                                -- in_sid                   in isi_firma_cfg.sid%type,
  ...
  then
    ...
    if v_mde_cfg.fkt_zaehler_0 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_0; end if;
    if v_mde_cfg.fkt_zaehler_1 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_1; end if;
    if v_mde_cfg.fkt_zaehler_2 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_2; end if;
    if v_mde_cfg.fkt_zaehler_3 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_3; end if;
    if v_mde_cfg.fkt_zaehler_4 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_4; end if;
    if v_mde_cfg.fkt_zaehler_5 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_5; end if;
    if v_mde_cfg.fkt_zaehler_6 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_6; end if;
    if v_mde_cfg.fkt_zaehler_7 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_7; end if;
    if v_mde_cfg.fkt_zaehler_8 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_8; end if;
    if v_mde_cfg.fkt_zaehler_9 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_9; end if;
    if v_mde_cfg.fkt_zaehler_10 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_10; end if;
    if v_mde_cfg.fkt_zaehler_11 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_11; end if;
    if v_mde_cfg.fkt_zaehler_12 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_12; end if;
    if v_mde_cfg.fkt_zaehler_13 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_13; end if;
    if v_mde_cfg.fkt_zaehler_14 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_14; end if;
    if v_mde_cfg.fkt_zaehler_15 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_15; end if;
    if v_mde_cfg.fkt_zaehler_16 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_16; end if;
    if v_mde_cfg.fkt_zaehler_17 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_17; end if;
    if v_mde_cfg.fkt_zaehler_18 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_18; end if;
    if v_mde_cfg.fkt_zaehler_19 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_19; end if;
    if v_mde_cfg.fkt_zaehler_20 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_20; end if;
    if v_mde_cfg.fkt_zaehler_21 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_21; end if;
    if v_mde_cfg.fkt_zaehler_22 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_22; end if;
    if v_mde_cfg.fkt_zaehler_23 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_23; end if;
    if v_mde_cfg.fkt_zaehler_24 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_24; end if;
    if v_mde_cfg.fkt_zaehler_25 = 4 then v_schrott_mg := v_schrott_mg + :new.delta_zaehler_25; end if;
    ...
    then
      ...
      then
        update bde_pd_prod p
           set p.schrott = p.schrott + v_schrott_mg
         where p.vorg_typ = 'PP'
           and p.leitzahl = :new.leitzahl
           and p.prod_ende = trunc(:new.datum, 'HH24')
           and p.res_id = v_res_zust_akt.res_id;
        ...
        insert into bde_pd_prod
          values(
                ...
                trunc(:new.datum, 'HH24'),      -- PROD_BEGINN   DATE not null,
                trunc(:new.datum, 'HH24'),      -- PROD_ENDE     DATE,
                0,                              -- PERS_NR       NUMBER,
                NULL,                           -- LAM_ID        NUMBER,
      ...
      update bde_fa_auftrag a
         set a.ag_ist_mg_schrott = a.ag_ist_mg_schrott + v_schrott_mg
       where a.leitzahl = :new.leitzahl
         and a.fa_ag = :new.fa_ag
         and a.fa_upos = nvl(:new.fa_upos, 0);
    end if;
  end if;
