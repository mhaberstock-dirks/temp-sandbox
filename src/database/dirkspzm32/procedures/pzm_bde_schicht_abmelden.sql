create or replace procedure dirkspzm32.pzm_bde_schicht_abmelden (
...
begin
    ...
    loop
        ...
        bde_pd_kopf_schicht_e(v_resource_zust_akt.sid, v_resource_zust_akt.firma_nr, v_resource_zust_akt.res_id, in_pers_nr, v_user.login_id
        );
...
-- sqlcl_snapshot {"hash":"936417befce2758286fa6fed2ea75fba3fea2e0a","type":"PROCEDURE","name":"PZM_BDE_SCHICHT_ABMELDEN","schemaName":"DIRKSPZM32","sxml":""}