create table dirkspzm32.pps_plan_auftrag_ag_fhm (
    sid                  varchar2(2 char) not null enable,
    firma_nr             number(6, 0) not null enable,
    plan_auf_ag_id       number(*, 0) not null enable,
    plan_auf_id          number(*, 0) not null enable,
    vorgang              number(*, 0) not null enable,
    pos_nr               number(*, 0) not null enable,
    ag_upos              number(*, 0) default 0 not null enable,
...
alter table dirkspzm32.pps_plan_auftrag_ag_fhm
    add constraint pk_pps_plan_auftrag_ag_fhm
        primary key ( vorgang,
                      pos_nr,
                      ag_upos,
                      prod_fhm,
