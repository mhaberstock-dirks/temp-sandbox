  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PZM_V_ZE_LOA_12MONATE_SUM" ("PERS_NR", "LZ_LOHNART", "SUM_LOA_STD_1", "SUM_LOA_STD_2", "SUM_LOA_STD_3", "SUM_LOA_STD_4", "SUM_LOA_STD_5", "SUM_LOA_STD_6", "SUM_LOA_STD_7", "SUM_LOA_STD_8", "SUM_LOA_STD_9", "SUM_LOA_STD_10", "SUM_LOA_STD_11", "SUM_LOA_STD_12") AS 
  select p.pers_nr,
       t.lz_lohnart,
...
-- sqlcl_snapshot {"hash":"cb82033ed9373374ac2ceb9b7be4b9d9818546bd","type":"VIEW","name":"PZM_V_ZE_LOA_12MONATE_SUM","schemaName":"DIRKSPZM32","sxml":""}