create or replace package body dirkspzm32.tms_p_base is
   ...
   ******************************************************************************************************/
    ...
    function get_kunden_auftr_pos (
        ...
        where
                t.kunden_auftr_pos_id = in_kunden_auftr_pos_id
            and t.firma_nr = in_firma_nr
            and t.sid = in_sid;
...
-- sqlcl_snapshot {"hash":"002383b2517b08724f4a40af2f5a613c7aeb6a2e","type":"PACKAGE_BODY","name":"TMS_P_BASE","schemaName":"DIRKSPZM32","sxml":""}