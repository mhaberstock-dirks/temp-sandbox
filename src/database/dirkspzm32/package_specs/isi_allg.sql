create or replace package dirkspzm32.isi_allg is
  ...
  */
  ...
  --------------------------------------------------------------------------------
    procedure c_set_client_info (
        v_cli in varchar2
    ); -- v$session.client_info%type
end isi_allg;
/


-- sqlcl_snapshot {"hash":"bad48a715433c30bffc1096f3de698cf2f9881ac","type":"PACKAGE_SPEC","name":"ISI_ALLG","schemaName":"DIRKSPZM32","sxml":""}