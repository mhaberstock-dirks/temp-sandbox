  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "A1_TEST_LAGER_ARTIKEL_VERT" ("LGR_ORT", "LTE_NAME", "ARTIKEL_ID", "ARTIKEL", "BEZEICHNUNG1", "CHARGE_BEZ", "LHM_NAME", "ANZAHL_LAM", "ANZAHL_RESERVIERT") AS 
  select lgr.lgr_ort,
       lte.lte_name,
       lam.artikel_id,
       a.artikel,
...
-- sqlcl_snapshot {"hash":"1ed620b4f86b290781a5223224669a3385935cc4","type":"VIEW","name":"A1_TEST_LAGER_ARTIKEL_VERT","schemaName":"DIRKSPZM32","sxml":""}