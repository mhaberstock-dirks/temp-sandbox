...
package body DIRKSPZM32.lvs_lager_abrechnung is
  ...
  */
  ...
  -------------------------------------------------------------------------------------*/
  function get_lte_we(in_sid               in  isi_sid.sid%type,
        ...
        from (
                  select bh.lte_id
                   ...
                   where bh.sid = in_sid
                     ...
                     and (';' || in_lgr_ort_liste || ';' like ('%;' || to_char(nvl(lgr.lgr_ort, 0)) || ';%') or in_lgr_ort_liste is NULL)
  ...
  /*-------------------------------------------------------------------------------------
    ...
    Etiketendruck
  -------------------------------------------------------------------------------------*/
  function get_lte_wa(in_sid               in  isi_sid.sid%type,
                      in_firma_nr          in  isi_firma.firma_nr%type,
                      in_ausw_start        in  date,
                      in_ausw_ende         in  date,
                      in_lgr_ort_liste     in varchar)
  ...
  /*-------------------------------------------------------------------------------------
    ...
    Etiketendruck
  -------------------------------------------------------------------------------------*/
  function get_lte_wa_o_komm_o_eti(in_sid               in  isi_sid.sid%type,
                                   in_firma_nr          in  isi_firma.firma_nr%type,
                                   in_ausw_start        in  date,
                                   in_ausw_ende         in  date,
                                   in_lgr_ort_liste     in varchar)
      ...
      select count(sel.lte_id)
        from (    select bh.lte_id
                   ...
                   where bh.sid = in_sid
                     ...
                     and bh.buch_datum > in_ausw_start
                     and bh.buch_datum < in_ausw_ende
                     and not exists (select lhm.lhm_id
                                       from lvs_lhm lhm,
                                            lvs_lam_bh bhx
                                      where bhx.lte_id = bh.lte_id
                                        and lhm.lhm_id = bhx.lhm_id
                                        and lhm.lhm_eti_druck_status = 'V')
                     and not exists (select xbh.lhm_id
                                       from lvs_lam_bh xbh,
                                            lvs_lgr xlgr
                                      where xbh.lam_id = bh.lam_id
                                        and xbh.menge > 0
                                        and xbh.bus = 6
                                        and xlgr.lgr_platz = xbh.lgr_platz
                                        and xlgr.lgr_ort = (select ylgr.lgr_ort from lvs_lgr ylgr where ylgr.lgr_platz = bh.lgr_platz)
                                    )
                   group by bh.lte_id
                  UNION
                  select bh.lte_id
                   ...
                   where bh.sid = in_sid
                     ...
                     and bh.buch_datum < in_ausw_ende
                     and not exists (select lhm.lhm_id
                                       from lvs_lhm_hist lhm,
                                            lvs_lam_bh_hist bhx
                                      where bhx.lte_id = bh.lte_id
                                        and lhm.lhm_id = bhx.lhm_id
                                        and lhm.lhm_eti_druck_status = 'V')
                     and not exists (select xbh.lhm_id
                                       from lvs_lam_bh_hist xbh,
                                            lvs_lgr xlgr
                                      where xbh.lam_id = bh.lam_id
                                        and xbh.menge > 0
                                        and xbh.bus = 6
  ...
  /*-------------------------------------------------------------------------------------
    ...
    Etiketendruck
  -------------------------------------------------------------------------------------*/
  function get_lte_wa_ohne_eti(in_sid               in  isi_sid.sid%type,
                               in_firma_nr          in  isi_firma.firma_nr%type,
                               in_ausw_start        in  date,
                               in_ausw_ende         in  date,
                               in_lgr_ort_liste     in varchar)
  ...
  -------------------------------------------------------------------------------------*/
  function get_lte_wa_mit_komm (in_sid               in  isi_sid.sid%type,
                                in_firma_nr          in  isi_firma.firma_nr%type,
                                in_ausw_start        in  date,
                                in_ausw_ende         in  date,
                                in_lgr_ort_liste     in varchar)
  ...
  -------------------------------------------------------------------------------------*/
  function get_lhm_wa_m_eti(in_sid              in  isi_sid.sid%type,
                            in_firma_nr          in  isi_firma.firma_nr%type,
                            in_ausw_start        in  date,
                            in_ausw_ende         in  date,
                            in_lgr_ort_liste     in varchar)
  ...
  -------------------------------------------------------------------------------------*/
  function get_lhm_wa_komm      (in_sid               in  isi_sid.sid%type,
                                in_firma_nr          in  isi_firma.firma_nr%type,
                                in_ausw_start        in  date,
                                in_ausw_ende         in  date,
                                in_lgr_ort_liste     in varchar)
  ...
  -------------------------------------------------------------------------------------*/
  function get_lhm_wa_komm_m_eti(in_sid              in  isi_sid.sid%type,
                                in_firma_nr          in  isi_firma.firma_nr%type,
                                in_ausw_start        in  date,
                                in_ausw_ende         in  date,
                                in_lgr_ort_liste     in varchar)
  ...
  -------------------------------------------------------------------------------------*/
  function get_lhm_wa_komm_o_eti(in_sid              in  isi_sid.sid%type,
                                in_firma_nr          in  isi_firma.firma_nr%type,
                                in_ausw_start        in  date,
                                in_ausw_ende         in  date,
                                in_lgr_ort_liste     in varchar)
  ...
  /*-------------------------------------------------------------------------------------
    ...
    Etiketendruck egal
  -------------------------------------------------------------------------------------*/
  function get_lhm_wa_komm_oup (in_sid               in  isi_sid.sid%type,
                                in_firma_nr          in  isi_firma.firma_nr%type,
                                in_ausw_start        in  date,
                                in_ausw_ende         in  date,
                                in_lgr_ort_liste     in varchar)
  ...
  /*-------------------------------------------------------------------------------------
    ...
    Etiketendruck
  -------------------------------------------------------------------------------------*/
  function get_lhm_wa_komm_oup_m_eti (in_sid               in  isi_sid.sid%type,
                                      in_firma_nr          in  isi_firma.firma_nr%type,
                                      in_ausw_start        in  date,
                                      in_ausw_ende         in  date,
                                      in_lgr_ort_liste     in varchar)
  ...
  /*-------------------------------------------------------------------------------------
    ...
    ohne Etiketendruck
  -------------------------------------------------------------------------------------*/
  function get_lhm_wa_komm_oup_o_eti (in_sid               in  isi_sid.sid%type,
                                      in_firma_nr          in  isi_firma.firma_nr%type,
                                      in_ausw_start        in  date,
                                      in_ausw_ende         in  date,
                                      in_lgr_ort_liste     in varchar)
  ...
  -------------------------------------------------------------------------------------*/
  function get_lte_platz_tage (in_sid               in  isi_sid.sid%type,
                               in_firma_nr          in  isi_firma.firma_nr%type,
    ...
    CURSOR c_lvs_bestand is
      select sum(nvl(dw.anz_lte, 0)) lte_anz
        from dw_lvs_bestand dw
       where dw.sid = in_sid
         ...
         and (';' || in_lte_status || ';'   like ('%;' || dw.lte_status || ';%') or in_lte_status is null)
         and (';' || in_lgr_ort_liste || ';' like ('%;' || to_char(nvl(dw.lgr_ort, 0)) || ';%') or in_lgr_ort_liste is NULL)
       group by nvl(dw.basis_lte_name, dw.lte_name);
