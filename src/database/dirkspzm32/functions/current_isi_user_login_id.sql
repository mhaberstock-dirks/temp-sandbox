create or replace function dirkspzm32.current_isi_user_login_id return number is
...
-- sqlcl_snapshot {"hash":"ba2cf254f9fefd7c24cb68264a3db951696f5724","type":"FUNCTION","name":"CURRENT_ISI_USER_LOGIN_ID","schemaName":"DIRKSPZM32","sxml":""}