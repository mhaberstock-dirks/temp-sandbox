  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LVS_V_LHM" ("SID", "FIRMA_NR", "LHM_ID", "LTE_ID", "LHM_NAME", "LGR_PLATZ", "LHM_VOL_HOEHE", "LHM_VOL_BREITE", "LHM_VOL_TIEFE", "LHM_VOL", "LHM_AKT_KG", "LHM_LETZTE_BUCHUNG", "LHM_ETI_DRUCK_STATUS", "KOMM_QUELL_LTE_ID", "KOMM_QUELL_LGR_PLATZ", "KOMM_NEU_LHM_NAME") AS 
...
-- sqlcl_snapshot {"hash":"0d64f2b8b212d7c4bc335187c487e23cfc1196fc","type":"VIEW","name":"LVS_V_LHM","schemaName":"DIRKSPZM32","sxml":""}