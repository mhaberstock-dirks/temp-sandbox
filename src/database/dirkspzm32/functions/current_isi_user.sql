create or replace 
function current_isi_user return varchar2 is
...
-- sqlcl_snapshot {"hash":"066391389796e6e7bc53d4ad029fbe983de096e1","type":"FUNCTION","name":"CURRENT_ISI_USER","schemaName":"DIRKSPZM32","sxml":""}