create or replace editionable trigger dirkspzm32.tr_s_erp_rcv_fa_auf_rel_biu before
    insert or update or delete on dirkspzm32.s_erp_rcv_fa_auf_rel
    for each row
declare
...
begin
    ...
    or inserting then
        ...
        if v_found then
            ...
            insert into s_rcv_fa_auf_rel values ( :new.sid,
                                                  :new.firma_nr,
                                                  :new.leitzahl,
                                                  :new.fa_ag,
                                                  :new.fa_upos,
...
-- sqlcl_snapshot {"hash":"a07b0e62fba327f1fde3af0f2003e58da47812a7","type":"TRIGGER","name":"TR_S_ERP_RCV_FA_AUF_REL_BIU","schemaName":"DIRKSPZM32","sxml":""}