  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TR_Z_PZM_SCHICHT_MOD_TO_INFOR_BIUD" 
  BEFORE DELETE OR INSERT OR UPDATE
  ON pzm_schicht_modelle
...
/
ALTER TRIGGER "TR_Z_PZM_SCHICHT_MOD_TO_INFOR_BIUD" ENABLE;


-- sqlcl_snapshot {"hash":"eb5c52ea375553713dfc851fdbbfb07df1d0a115","type":"TRIGGER","name":"TR_Z_PZM_SCHICHT_MOD_TO_INFOR_BIUD","schemaName":"DIRKSPZM32","sxml":""}