  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ISI_V_AUTO_MESSAGING" ("KATEGORIE_IX", "DESCRIPTION", "TYPE_2", "SAVE_2", "MAIL_2", "PRINT_2", "MAIL_BODY", "DATA_CRITERIA", "MAIL_FROM_DISPLAY_NAME", "MAIL_FROM_USER_LOGIN_ID", "MAIL_HOST", "REPORT_LAYOUT_NAME", "REPORT_LAYOUT_PATH", "MAIL_PORT", "FILE_NAME", "ACTION_TIMING", "MAIL_TITLE", "MAIL_TO_DISPLAY_NAME", "ACTION_TYPE") AS 
...
-- sqlcl_snapshot {"hash":"b5938fc0ebe16caed953406fe7510f884c7e1c8c","type":"VIEW","name":"ISI_V_AUTO_MESSAGING","schemaName":"DIRKSPZM32","sxml":""}