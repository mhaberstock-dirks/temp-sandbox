  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BDE_V_PD_LAM_STL_DATEN" ("SID", "FIRMA_NR", "PD_LAM_STL_DATEN_ID", "FERT_LAM_ID", "FA_NR", "FA_AG", "FA_UPOS", "FA_AG_STL_ID", "STL_LAM_ID", "STL_LAM_AB_MENGE", "STL_LAM_IST_MENGE", "STATUS", "AEND_DATUM", "AEND_LOGIN_ID", "RES_ID", "RES_STATUS_ID", "RESULT_PARAMS", "RES_NAME", "FE_ARTIKEL_ID", "FE_ARTIKEL", "FE_ZEICHNUNG", "FE_ZINDEX", "MA_ARTIKEL_ID", "MA_ART_GRUPPE_ID", "MA_ARTIKEL", "MA_ZEICHNUNG", "MA_ZINDEX", "MA_ART_GRUPPE", "MA_PROD_PARAMS", "PROD_MENGE_IX", "FA_SATZART", "FA_AG_BEZ1", "FA_AG_BEZ2") AS 
...
-- sqlcl_snapshot {"hash":"08e3e7c1ee23889d75206a865dde4e476072d11c","type":"VIEW","name":"BDE_V_PD_LAM_STL_DATEN","schemaName":"DIRKSPZM32","sxml":""}