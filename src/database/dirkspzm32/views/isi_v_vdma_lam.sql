  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ISI_V_VDMA_LAM" ("ARTIKEL", "ART_BEZ", "GET_AUSW_BEGIN", "GET_AUSW_ENDE", "LGR_ORT", "LGR_ORT_TEXT", "AKT_MENGE", "DW_D_MENGE", "ABG_MENGE", "MENGENEINHEIT_BASIS", "LAGERUMSCHLAGSHAEUFIGKEIT", "D_LAGERDAUER", "LAGER_ZINSSATZ", "LAGERREICHWEITE_MONATE", "D_LAGERREICHWEITE_MONATE") AS 
  select d."ARTIKEL",
       d."ART_BEZ",
       d."GET_AUSW_BEGIN",
       d."GET_AUSW_ENDE",
...
-- sqlcl_snapshot {"hash":"275f2b22e6b9c6da0eb943b17e26782db309308e","type":"VIEW","name":"ISI_V_VDMA_LAM","schemaName":"DIRKSPZM32","sxml":""}