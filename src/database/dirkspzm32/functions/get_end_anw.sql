create or replace function dirkspzm32.get_end_anw (
    p_pers_nr in number,
    p_datum   in date
) return date is
...
-- sqlcl_snapshot {"hash":"7b432d060111dad2311fdac1156601d447c261a4","type":"FUNCTION","name":"GET_END_ANW","schemaName":"DIRKSPZM32","sxml":""}