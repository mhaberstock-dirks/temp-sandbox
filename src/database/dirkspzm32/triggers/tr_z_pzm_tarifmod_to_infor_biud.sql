  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TR_Z_PZM_TARIFMOD_TO_INFOR_BIUD" 
...
/
ALTER TRIGGER "TR_Z_PZM_TARIFMOD_TO_INFOR_BIUD" ENABLE;


-- sqlcl_snapshot {"hash":"7b736a22afbf9b2d27c405b81c962ee1361d8e33","type":"TRIGGER","name":"TR_Z_PZM_TARIFMOD_TO_INFOR_BIUD","schemaName":"DIRKSPZM32","sxml":""}