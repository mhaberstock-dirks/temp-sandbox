create or replace 
procedure INSERT_KRANKMELDUNG(p_pers_nr in number,
                                                p_beginn in date,
                                                p_ende in date,
                                                p_aa_id in number,
...
-- sqlcl_snapshot {"hash":"9e2a87d02ea03751a4959d83cebe400e06ebe5e6","type":"PROCEDURE","name":"INSERT_KRANKMELDUNG","schemaName":"DIRKSPZM32","sxml":""}