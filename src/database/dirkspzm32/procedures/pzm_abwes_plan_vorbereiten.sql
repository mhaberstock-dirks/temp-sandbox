create or replace 
procedure pzm_abwes_plan_vorbereiten(in_start_date in date,
                                                       in_end_date in date,
...
-- sqlcl_snapshot {"hash":"fe1e7881f168ca0086acd58619f37d353f215c32","type":"PROCEDURE","name":"PZM_ABWES_PLAN_VORBEREITEN","schemaName":"DIRKSPZM32","sxml":""}