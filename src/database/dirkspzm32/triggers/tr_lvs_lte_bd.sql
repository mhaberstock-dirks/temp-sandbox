create or replace editionable trigger dirkspzm32.tr_lvs_lte_bd before
    delete on dirkspzm32.lvs_lte
    for each row
declare
  -- local variables here
 begin
    insert into lvs_lte_hist values ( :old.sid,
                                      :old.firma_nr,
                                      :old.lte_id,
                                      :old.lte_name,
                                      :old.lgr_ort,
...
-- sqlcl_snapshot {"hash":"81983b1732897ce140058eb2857f15ac52743e1c","type":"TRIGGER","name":"TR_LVS_LTE_BD","schemaName":"DIRKSPZM32","sxml":""}