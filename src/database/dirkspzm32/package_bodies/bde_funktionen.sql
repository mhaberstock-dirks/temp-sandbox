...
/*
  ...
  @return p_ausw_ende
*/
  function set_aus_ende(in_ausw_ende in date) return date is
  begin
...
-------------------------------------------------------------------------------------------------------
  ...
  begin
    ...
    */
    ...
    pps_p_bde.storno_bde_fa_dispo(in_sid,
                                  in_firma,
                                  in_leitzahl,
                                  NULL,
                                  NULL,
...
*/
  function get_fa_zeit_mg_upos_von_bis(in_sid            in isi_sid.sid%type,
    ...
    CURSOR c_prod_daten is
     select pd_fa.*
       from bde_pd_prod pd_fa
      where pd_fa.leitzahl = in_leitzahl
      ...
      then
        ...
        LOOP
          ...
          then
            ...
            if v_prod_kopf.pd_kopf_beginn > v_prod_daten.prod_ende
            then
              EXIT;
            else
              if nvl(v_prod_kopf.pd_kopf_ende, sysdate) > v_prod_daten.prod_ende
              then
                v_prod_kopf.pd_kopf_ende := v_prod_daten.prod_ende;
              end if;
              if v_prod_kopf.pd_kopf_beginn < v_prod_daten.prod_beginn
              then
              ...
              LOOP
                ...
                then
                  ...
                  if v_res_status.st_start > nvl(v_prod_kopf.pd_kopf_ende, sysdate)
                  then
                    EXIT;
                  else
                    if nvl(v_res_status.st_ende, sysdate) > nvl(v_prod_kopf.pd_kopf_ende, sysdate)
                    then
                      v_res_status.st_ende := nvl(v_prod_kopf.pd_kopf_ende, sysdate);
                    end if;
                    if v_res_status.st_start < v_prod_kopf.pd_kopf_beginn
                    then
                    ...
                    if v_res_status_cfg.res_st_id != 0
                    then
                      if v_res_status_cfg.st_gruppe = 'R' -- Rüsten
                      then
                        v_count_ruest := v_count_ruest + 1;
                        v_ruest_std := v_ruest_std  + (nvl(v_res_status.st_ende, sysdate) - v_res_status.st_start) * 24;
                      else
                        v_count_stoer := v_count_stoer + 1;
                        v_unterb_std := v_unterb_std + (nvl(v_res_status.st_ende, sysdate) - v_res_status.st_start) * 24;
...
*/
  ...
  begin
    ...
    LOOP
      ...
      if (v_bde_prod.prod_ende - trunc(v_bde_prod.prod_ende) < 14 / 24)
      ...
      elsif (v_bde_prod.prod_ende - trunc(v_bde_prod.prod_ende) < 22 / 24)
...
*/
  function get_mde_gut_mengen (in_res_id                 in mde_cfg.res_id%type,
    ...
    CURSOR c_mde_cfg is
      select *
        from mde_cfg cfg
       where cfg.res_id   = in_res_id;

    CURSOR c_mde_stat is
      select *
        from mde_statistik m
  ...
  begin
    ...
    LOOP
      ...
      if v_mde_cfg.fkt_zaehler_0 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_0; end if;
      if v_mde_cfg.fkt_zaehler_0 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_0; end if;
      if v_mde_cfg.fkt_zaehler_0 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_0; end if;
      if v_mde_cfg.fkt_zaehler_0 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_0; end if;

      if v_mde_cfg.fkt_zaehler_1 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_1; end if;
      if v_mde_cfg.fkt_zaehler_1 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_1; end if;
      if v_mde_cfg.fkt_zaehler_1 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_1; end if;
      if v_mde_cfg.fkt_zaehler_1 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_1; end if;

      if v_mde_cfg.fkt_zaehler_2 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_2; end if;
      if v_mde_cfg.fkt_zaehler_2 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_2; end if;
      if v_mde_cfg.fkt_zaehler_2 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_2; end if;
      if v_mde_cfg.fkt_zaehler_2 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_2; end if;

      if v_mde_cfg.fkt_zaehler_3 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_3; end if;
      if v_mde_cfg.fkt_zaehler_3 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_3; end if;
      if v_mde_cfg.fkt_zaehler_3 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_3; end if;
      if v_mde_cfg.fkt_zaehler_3 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_3; end if;

      if v_mde_cfg.fkt_zaehler_4 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_4; end if;
      if v_mde_cfg.fkt_zaehler_4 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_4; end if;
      if v_mde_cfg.fkt_zaehler_4 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_4; end if;
      if v_mde_cfg.fkt_zaehler_4 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_4; end if;

      if v_mde_cfg.fkt_zaehler_5 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_5; end if;
      if v_mde_cfg.fkt_zaehler_5 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_5; end if;
      if v_mde_cfg.fkt_zaehler_5 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_5; end if;
      if v_mde_cfg.fkt_zaehler_5 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_5; end if;

      if v_mde_cfg.fkt_zaehler_6 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_6; end if;
      if v_mde_cfg.fkt_zaehler_6 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_6; end if;
      if v_mde_cfg.fkt_zaehler_6 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_6; end if;
      if v_mde_cfg.fkt_zaehler_6 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_6; end if;

      if v_mde_cfg.fkt_zaehler_7 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_7; end if;
      if v_mde_cfg.fkt_zaehler_7 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_7; end if;
      if v_mde_cfg.fkt_zaehler_7 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_7; end if;
      if v_mde_cfg.fkt_zaehler_7 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_7; end if;

      if v_mde_cfg.fkt_zaehler_8 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_8; end if;
      if v_mde_cfg.fkt_zaehler_8 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_8; end if;
      if v_mde_cfg.fkt_zaehler_8 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_8; end if;
      if v_mde_cfg.fkt_zaehler_8 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_8; end if;

      if v_mde_cfg.fkt_zaehler_9 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_9; end if;
      if v_mde_cfg.fkt_zaehler_9 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_9; end if;
      if v_mde_cfg.fkt_zaehler_9 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_9; end if;
      if v_mde_cfg.fkt_zaehler_9 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_9; end if;

      if v_mde_cfg.fkt_zaehler_10 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_10; end if;
      if v_mde_cfg.fkt_zaehler_10 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_10; end if;
      if v_mde_cfg.fkt_zaehler_10 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_10; end if;
      if v_mde_cfg.fkt_zaehler_10 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_10; end if;

      if v_mde_cfg.fkt_zaehler_11 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_11; end if;
      if v_mde_cfg.fkt_zaehler_11 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_11; end if;
      if v_mde_cfg.fkt_zaehler_11 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_11; end if;
      if v_mde_cfg.fkt_zaehler_11 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_11; end if;

      if v_mde_cfg.fkt_zaehler_12 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_12; end if;
      if v_mde_cfg.fkt_zaehler_12 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_12; end if;
      if v_mde_cfg.fkt_zaehler_12 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_12; end if;
      if v_mde_cfg.fkt_zaehler_12 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_12; end if;

      if v_mde_cfg.fkt_zaehler_13 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_13; end if;
      if v_mde_cfg.fkt_zaehler_13 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_13; end if;
      if v_mde_cfg.fkt_zaehler_13 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_13; end if;
      if v_mde_cfg.fkt_zaehler_13 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_13; end if;

      if v_mde_cfg.fkt_zaehler_14 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_14; end if;
      if v_mde_cfg.fkt_zaehler_14 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_14; end if;
      if v_mde_cfg.fkt_zaehler_14 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_14; end if;
      if v_mde_cfg.fkt_zaehler_14 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_14; end if;

      if v_mde_cfg.fkt_zaehler_15 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_15; end if;
      if v_mde_cfg.fkt_zaehler_15 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_15; end if;
      if v_mde_cfg.fkt_zaehler_15 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_15; end if;
      if v_mde_cfg.fkt_zaehler_15 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_15; end if;

      if v_mde_cfg.fkt_zaehler_16 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_16; end if;
      if v_mde_cfg.fkt_zaehler_16 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_16; end if;
      if v_mde_cfg.fkt_zaehler_16 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_16; end if;
      if v_mde_cfg.fkt_zaehler_16 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_16; end if;

      if v_mde_cfg.fkt_zaehler_17 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_17; end if;
      if v_mde_cfg.fkt_zaehler_17 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_17; end if;
      if v_mde_cfg.fkt_zaehler_17 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_17; end if;
      if v_mde_cfg.fkt_zaehler_17 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_17; end if;

      if v_mde_cfg.fkt_zaehler_18 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_18; end if;
      if v_mde_cfg.fkt_zaehler_18 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_18; end if;
      if v_mde_cfg.fkt_zaehler_18 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_18; end if;
      if v_mde_cfg.fkt_zaehler_18 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_18; end if;

      if v_mde_cfg.fkt_zaehler_19 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_19; end if;
      if v_mde_cfg.fkt_zaehler_19 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_19; end if;
      if v_mde_cfg.fkt_zaehler_19 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_19; end if;
      if v_mde_cfg.fkt_zaehler_19 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_19; end if;

      if v_mde_cfg.fkt_zaehler_20 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_20; end if;
      if v_mde_cfg.fkt_zaehler_20 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_20; end if;
      if v_mde_cfg.fkt_zaehler_20 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_20; end if;
      if v_mde_cfg.fkt_zaehler_20 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_20; end if;

      if v_mde_cfg.fkt_zaehler_21 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_21; end if;
      if v_mde_cfg.fkt_zaehler_21 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_21; end if;
      if v_mde_cfg.fkt_zaehler_21 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_21; end if;
      if v_mde_cfg.fkt_zaehler_21 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_21; end if;

      if v_mde_cfg.fkt_zaehler_22 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_22; end if;
      if v_mde_cfg.fkt_zaehler_22 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_22; end if;
      if v_mde_cfg.fkt_zaehler_22 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_22; end if;
      if v_mde_cfg.fkt_zaehler_22 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_22; end if;

      if v_mde_cfg.fkt_zaehler_23 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_23; end if;
      if v_mde_cfg.fkt_zaehler_23 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_23; end if;
      if v_mde_cfg.fkt_zaehler_23 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_23; end if;
      if v_mde_cfg.fkt_zaehler_23 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_23; end if;

      if v_mde_cfg.fkt_zaehler_24 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_24; end if;
      if v_mde_cfg.fkt_zaehler_24 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_24; end if;
      if v_mde_cfg.fkt_zaehler_24 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_24; end if;
      if v_mde_cfg.fkt_zaehler_24 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_24; end if;

      if v_mde_cfg.fkt_zaehler_25 = 2 then v_gut_mg := v_gut_mg + v_mde_stat.delta_zaehler_25; end if;
      if v_mde_cfg.fkt_zaehler_25 = 3 then v_b_mg := v_b_mg + v_mde_stat.delta_zaehler_25; end if;
      if v_mde_cfg.fkt_zaehler_25 = 4 then v_schrott_mg := v_schrott_mg + v_mde_stat.delta_zaehler_25; end if;
      if v_mde_cfg.fkt_zaehler_25 = 5 then v_micro_stops := v_micro_stops + v_mde_stat.delta_zaehler_25; end if;

      if (v_mde_stat.datum - trunc(v_mde_stat.datum) < 14 / 24)
      ...
      elsif (v_mde_stat.datum - trunc(v_mde_stat.datum) < 22 / 24)
...
*/
  function get_res_prod_std(in_res_id         in isi_resource.res_id%type,
    ...
    CURSOR c_pd_kopf is
      select *
        from bde_pd_kopf t
       where t.pd_kopf_ende > in_ausw_begin
         and t.pd_kopf_beginn < in_ausw_ende
         and t.res_id = in_res_id
       order by t.pd_kopf_beginn;

    CURSOR c_res_status is
      select rs.*
        from isi_res_status rs
       where rs.res_id = in_res_id
    ...
    CURSOR c_res_status_cfg is
      select rsc.*
        from isi_res_status_cfg rsc
       where rsc.sid = v_res_status.sid
         and rsc.firma_nr = v_res_status.firma_nr
         and rsc.res_st_id = v_res_status.res_st_id;
  begin
    if  v_ausw_funk            = 'get_res_prod_std'
    ...
    LOOP
      ...
      v_found := c_res_status%FOUND and c_pd_kopf%FOUND;
      if not v_found
      then
        EXIT;
      else
        if v_res_status.st_start > in_ausw_ende
        then
          EXIT;
        else
          v_ende_status := v_res_status.st_ende;
          if v_res_status.st_ende > in_ausw_ende
          then
          ...
          LOOP
            ...
            if v_res_status.st_ende > v_pd_kopf.pd_kopf_ende
            then
              v_res_status.st_ende := v_pd_kopf.pd_kopf_ende;
            end if;

            if v_res_status.st_start < in_ausw_begin
            then
              v_res_status.st_start := in_ausw_begin;
            end if;
            if v_res_status.st_start < v_pd_kopf.pd_kopf_beginn
            then
              v_res_status.st_start := v_pd_kopf.pd_kopf_beginn;
            end if;

            if v_res_status.st_start > v_res_status.st_ende
            then
            ...
            then
              ...
              if v_res_status_cfg.st_gruppe = 'P'
              then
            ...
            LOOP
              ...
              or v_begin - trunc(v_begin) >= 22 / 24
              then
                if v_ende - trunc(v_begin) > 30 / 24
                then
              ...
              if v_begin - trunc(v_begin) < 14 / 24
              and v_begin - trunc(v_begin) >= 6 / 24
              then
                if v_ende - trunc(v_begin) > 14 / 24
                then
              ...
              if v_begin - trunc(v_begin) < 22 / 24
              and v_begin - trunc(v_begin) >= 14 / 24
              then
                if v_ende - trunc(v_begin) > 22 / 24
                then
...
*/
  ...
  begin
    ...
    select count(*)  into v_prod_tage
      from (
        select count(trunc(t.sa_beginn - 5.5 / 24))
          from bde_pd_kopf t
         where t.res_id = in_res_id
...
*/
  ...
  begin
    ...
    select count(*)  into v_prod_Schichten
      from (
        select count(trunc(t.sa_beginn - 5.5 / 24))
          from bde_pd_kopf t
         where t.res_id = in_res_id
           and t.sa_beginn >= in_ausw_begin
           and t.sa_beginn < in_ausw_ende
         group by trunc(t.sa_beginn - 5.5 / 24), -- Schichttag
...
*/
  ...
  v_anm_std                number;
  CURSOR c_anm_std is
    select sum ((case when p.pd_kopf_ende > in_ende
                      then in_ende
                      else p.pd_kopf_ende
                      end -
                 case when p.pd_kopf_beginn < in_begin
                      then in_begin
                      else p.pd_kopf_beginn
                      end) * 24)
      from bde_pd_kopf p
     where p.sid = in_sid
  ...
  begin
    ...
    if  v_ausw_funk            = 'get_anmelde_std'
    and v_ausw_res_id          = in_res_id
    ...
    LOOP
      ...
      then
        ...
        update bde_fa_auftrag t
           set t.ag_ist_mg = t.ag_ist_mg - v_lam_bh.menge + in_menge
         where t.sid = in_sid
           and t.firma_nr = in_firma_nr
           and t.leitzahl = in_leitzahl
           and t.fa_ag = in_fa_ag
      ...
      if v_lam_anz_menge = 0
      then
        bde_pd_prod_p_pp_u(in_sid,
                           v_lam_bh.lam_id,
                           in_menge,
                           NULL);
...
*/
  ...
  CURSOR c_bde_pd_prod is
    select *
      from bde_pd_prod p
     where nvl(p.res_id, -1) = in_res_id
...
*/
  ...
  begin
    update bde_fa_auftrag t
       set t.ag_ist_mg = t.ag_ist_mg + in_menge - in_old_menge
       where t.sid = in_sid
         and t.firma_nr = in_firma_nr
         and t.leitzahl = in_leitzahl
         and t.fa_ag = in_fa_ag
    ...
    update bde_pd_prod p
        set p.menge_a = p.menge_a + in_menge - in_old_menge
       where p.leitzahl = in_leitzahl
         and p.fa_ag = in_fa_ag
         and p.fa_upos = in_fa_upos
         and p.vorg_typ = 'PA'
...
*/
  ...
  begin
    update bde_fa_auftrag t
       set t.ag_ist_mg_schrott = nvl(t.ag_ist_mg_schrott, 0) + in_menge - in_old_menge
       where t.sid = in_sid
         and t.firma_nr = in_firma_nr
         and t.leitzahl = in_leitzahl
         and t.fa_ag = in_fa_ag
         and t.fa_upos = in_fa_upos;
    update bde_pd_prod p
        set p.schrott = nvl(p.schrott, 0) + in_menge - in_old_menge
       where p.leitzahl = in_leitzahl
         and p.fa_ag = in_fa_ag
         and p.fa_upos = in_fa_upos
         and p.vorg_typ = 'PA'
...
*/
  ...
  begin
    ...
    update bde_fa_auftrag t
       set t.ag_ist_mg = nvl(t.ag_ist_mg, 0) + nvl(in_menge, 0),
  ...
  function get_ma_erf_zeiten(in_sid           in  isi_sid.sid%type,
    ...
    CURSOR c_prod_kopf_ma is
     select kma.res_id,
            ...
            in_aufgabe_bis,
            (
             case when nvl(kma.pd_kopf_ende, sysdate) > in_aufgabe_bis
                  then in_aufgabe_bis
                  else nvl(kma.pd_kopf_ende, sysdate)
                  end
             -
             case when kma.pd_kopf_beginn < in_aufgabe_seit
                  then in_aufgabe_seit
                  else kma.pd_kopf_beginn
                  end
            ) * 24 ma_zeit_erf
       from bde_pd_kopf_ma kma
      where kma.sid = in_sid
