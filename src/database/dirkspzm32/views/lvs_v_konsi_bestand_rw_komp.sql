  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LVS_V_KONSI_BESTAND_RW_KOMP" ("ADR_NR", "NAME_1", "ADR_LIEFER", "LGR_PLATZ", "LTE_ID", "LTE_NAME", "LGR_ORT", "ARTIKEL", "BEZEICHNUNG1", "WAREN_GRUPPE", "LTE_LETZTE_BUCHUNG", "MENGENEINHEIT", "MENGE", "LABOR_STATUS", "VERBAUT") AS 
  select adr.adr_nr,
       adr.name_1,
       adr.adr_liefer,
       lam.lgr_platz,
...
-- sqlcl_snapshot {"hash":"88ded61903c32d33a5ae275c80fe09e94753541e","type":"VIEW","name":"LVS_V_KONSI_BESTAND_RW_KOMP","schemaName":"DIRKSPZM32","sxml":""}