  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TR_Z_PZM_VERTRAGSARTEN_TO_INFOR_BIUD" 
  BEFORE INSERT OR UPDATE OR DELETE
  ON pzm_vertragsarten
  FOR EACH ROW
...
BEGIN
  z_pzm_infor_sst.ins_pzm_stammdaten_to_infor (
    i_tabelle       => 'PZM_VERTRAGSARTEN'
  , i_pk_felder     => 'VA_ID'
  , i_value         => CASE WHEN INSERTING THEN :new.va_id WHEN UPDATING OR DELETING THEN :old.va_id END
...
END;
/
ALTER TRIGGER "TR_Z_PZM_VERTRAGSARTEN_TO_INFOR_BIUD" ENABLE;


-- sqlcl_snapshot {"hash":"cb7426f1a6d54a27fe746cc1f70a30373fbce7b1","type":"TRIGGER","name":"TR_Z_PZM_VERTRAGSARTEN_TO_INFOR_BIUD","schemaName":"DIRKSPZM32","sxml":""}