  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CHK_AUSL_ORDER_TEST3" ("OK_STATUS", "VORGANG_ID", "AUF_ID", "ARTIKEL", "LTE_ID", "LGR_PLATZ", "RESERVIERT", "LGR_VERWENDUNG_LTE_STATUS", "CHECK_FA", "Q_LGR_ORT_SEMIKOLON", "LAM_MENGE_ULHM", "Q_LGR_ORT_ORDER_LTE", "ORDER_POS_AUTO_DEPAL", "ORDER_POS_WARE_DISPONIERT", "M_INV", "LABOR_ST", "LAM_SEL1_10", "CHARGE", "SERIE", "MHD", "MIN_MHD", "ANBRUCH", "CHK_RESERV", "KONSI", "P_DATUM", "LGR_GESPERRT", "L_INV", "L_ORTE", "FARZEUG_OK", "Z_IDX", "Z_MENGE", "LEITZAHL", "FA_AG", "MENGE", "RESERVIERTE_MENGE", "ReifeZeit", "LAM_TEXT", "ZUG_DATUM", "LABOR_STATUS", "LAM_RES_FUER_AUF_ID", "LTE_RES_FUER_VORGANG_ID", "PLATZ_GESP", "LGR_VERWENDUNG", "LAM_MHD", "RES_MHD", "CHARGE_BEZ", "MIN_MHD_R", "AUSL_SORT", "AUSL_SORT2", "KUNDEN_NR", "NAME_1") AS 
...
-- sqlcl_snapshot {"hash":"2c5296e61f5c285a7810aa28e83b677b8eedb697","type":"VIEW","name":"CHK_AUSL_ORDER_TEST3","schemaName":"DIRKSPZM32","sxml":""}