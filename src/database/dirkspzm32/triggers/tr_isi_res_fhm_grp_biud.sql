create or replace editionable trigger dirkspzm32.tr_isi_res_fhm_grp_biud before
    insert or update on dirkspzm32.isi_res_fhm_grp
    for each row
declare
...
-- sqlcl_snapshot {"hash":"ab4036ef37d22d010eea908ab2c36eff333c44f5","type":"TRIGGER","name":"TR_ISI_RES_FHM_GRP_BIUD","schemaName":"DIRKSPZM32","sxml":""}