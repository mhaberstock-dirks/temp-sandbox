create or replace 
function get_charge_id(p_sid in isi_sid.sid%type,
...
-- sqlcl_snapshot {"hash":"809bdbbf354b3b8772fc428702b2b3b8ca2af61b","type":"FUNCTION","name":"GET_CHARGE_ID","schemaName":"DIRKSPZM32","sxml":""}