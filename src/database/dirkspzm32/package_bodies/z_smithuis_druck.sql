create or replace package body dirkspzm32.z_smithuis_druck is
  ...
  -- Function and procedure implementations
    function ccg_etikett (
        ...
        select
            ...
            || lpad(lam.menge, 6, '0')
            || '(15)'
            || to_char(lam.lam_mhd_ausgabe, 'YYMMDD')             as "BC1_Text",
            '(02)'
            || lpad(
                nvl(art.lhm_ean, '0'),
                14,
            ...
            || lpad(lam.menge, 6, '0')
            || '(15)'
            || to_char(lam.lam_mhd_ausgabe, 'YYMMDD')             as "BC4_Text",
            '(02)'
            || lpad(
                nvl(art.lhm_ean, '0'),
                14,
            ...
            || cha.charge_bez
            || '(15)'
            || to_char(lam.lam_mhd_ausgabe, 'YYMMDD')             as "BC6_Text",
            '93'
            || lte.lte_id
            || chr(29)
            || '37'
            ...
            || chr(29)
            || '15'
            || to_char(lam.lam_mhd_ausgabe, 'YYMMDD')             as bc1,
            '02'
            || lpad(
                nvl(art.lhm_ean, '0'),
                14,
            ...
            || chr(29)
            || '15'
            || to_char(lam.lam_mhd_ausgabe, 'YYMMDD')             as bc4,
            '02'
            || lpad(
                nvl(art.lhm_ean, '0'),
                14,
            ...
            || chr(29)
            || '15'
            || to_char(lam.lam_mhd_ausgabe, 'YYMMDD')             as bc6
        from
            lvs_lte     lte,
            lvs_lam     lam,
            isi_artikel art,
...
-- sqlcl_snapshot {"hash":"a1f4d11e3eef4e62f909957b198e6115e082e308","type":"PACKAGE_BODY","name":"Z_SMITHUIS_DRUCK","schemaName":"DIRKSPZM32","sxml":""}