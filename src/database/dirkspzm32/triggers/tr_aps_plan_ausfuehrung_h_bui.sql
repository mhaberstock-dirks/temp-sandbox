  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TR_APS_PLAN_AUSFUEHRUNG_H_BUI" 
  before update or insert
  on APS_PLAN_AUSFUEHRUNG_HIST 
  for each row
declare
...
/
ALTER TRIGGER "TR_APS_PLAN_AUSFUEHRUNG_H_BUI" ENABLE;


-- sqlcl_snapshot {"hash":"2a47944ee32cb565530a440fd01879cbcec1daf7","type":"TRIGGER","name":"TR_APS_PLAN_AUSFUEHRUNG_H_BUI","schemaName":"DIRKSPZM32","sxml":""}