  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "DIRKSPZM32"."PZM_ZV_PAYROLLDATA_BASE" ("RESPONSIBLE_NR", "PB_ID", "F_ABT_ID", "NAME", "RFID", "PERSNR", "ABT_ID", "ABT_NAME", "KOSTENSTELLE", "DATUM", "GEBUCHTE_KOSTENSTELLE", "TS_AA_ID", "AA_KURZNAME", "KENNZ_URLAUB", "TS_DAY_ABW_STD", "KOMMT", "GEHT", "GEZAEHLT_VON", "GEZAEHLT_BIS", "ANTEIL_ZEIT", "IST_ZEIT", "GEBUCHTE_ZEIT", "ABWEICHUNG_MINUTEN", "ZE_ANW_STD", "TS_DAY_PAUSE_STD", "ZE_GEZ_KST_STD", "KOMMT_DATUM", "GEHT_DATUM", "GEZ_VON_DATUM", "GEZ_BIS_DATUM", "SA_KURZNAME") AS 
  WITH
    qb_pa     /******************************************************************************
...
-- sqlcl_snapshot {"hash":"3f4b2d326031aa17b36e53b8fca10e70e96c4cae","type":"VIEW","name":"PZM_ZV_PAYROLLDATA_BASE","schemaName":"DIRKSPZM32","sxml":""}