create or replace package dirkspzm32.pzm_p_zeiterfassung is
  -----------------------------------------------------------------------------------------------
...
-- sqlcl_snapshot {"hash":"1a8ff524f24d22152547acf1a097146ebbf570d5","type":"PACKAGE_SPEC","name":"PZM_P_ZEITERFASSUNG","schemaName":"DIRKSPZM32","sxml":""}