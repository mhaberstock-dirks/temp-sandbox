create or replace package dirkspzm32.fls_p_bde is
  ...
  */
	...
	-------------------------------------------------------------------------------------------------------
    function get_version return varchar2; --# Aktuelle Version mit Datum (siehe #Konstanten )
...
-- sqlcl_snapshot {"hash":"5d72e82064772ed4c741618719edfd9916974a26","type":"PACKAGE_SPEC","name":"FLS_P_BDE","schemaName":"DIRKSPZM32","sxml":""}