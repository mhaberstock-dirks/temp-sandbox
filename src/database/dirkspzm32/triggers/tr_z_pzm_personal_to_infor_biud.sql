  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TR_Z_PZM_PERSONAL_TO_INFOR_BIUD" 
  BEFORE INSERT OR UPDATE OR DELETE
  ON pzm_personal
  FOR EACH ROW

  /******************************************************************************
     NAME:       tr_z_pzm_personal_to_infor_biud
     ...
     Automatically available Auto Replace Keywords:
        Object Name:     tr_z_pzm_personal_to_infor_biud
        Sysdate:         17.07.2026
...
BEGIN
  z_pzm_infor_sst.ins_pzm_stammdaten_to_infor (
    ...
    , i_value         =>
        CASE
          WHEN INSERTING THEN :new.pers_nr
          WHEN UPDATING OR DELETING THEN :old.pers_nr
        END
  ...
  EXCEPTION
    ...
    THEN
      pzm_p_log.log_exception (p_category   => pzm_p_log.cat_system
                             , p_module     => 'trigger tr_z_pzm_personal_to_infor_biud'
...
END;
/
ALTER TRIGGER "TR_Z_PZM_PERSONAL_TO_INFOR_BIUD" ENABLE;


-- sqlcl_snapshot {"hash":"c14d4efe6554b7d9c8bf729584f5ed9dcb2dd3ba","type":"TRIGGER","name":"TR_Z_PZM_PERSONAL_TO_INFOR_BIUD","schemaName":"DIRKSPZM32","sxml":""}