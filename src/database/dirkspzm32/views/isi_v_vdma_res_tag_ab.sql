  ...
  select r.res_ext_name,
         ...
         bde_funktionen.get_res_prod_std(r.res_id, (bde_funktionen.get_ausw_begin), (bde_funktionen.get_ausw_ende))
                                         + bde_funktionen.get_res_ruest_std + bde_funktionen.get_res_up_unterbr_std blz,
         bde_funktionen.get_res_prod_std(r.res_id, (bde_funktionen.get_ausw_begin), (bde_funktionen.get_ausw_ende))
                                         + bde_funktionen.get_res_ruest_std baz,
         ...
         nvl((select sum(pdx.menge_a + pdx.menge_b + pdx.schrott) from bde_pd_prod pdx where r.res_id = pdx.res_id
                                                                                     and pdx.vorg_typ  = 'PA'
                                                                                     and pdx.prod_ende >= (bde_funktionen.get_ausw_begin)
                                                                                     and pdx.prod_ende <=  (bde_funktionen.get_ausw_ende)), 0
            ) pm,
         nvl((select sum(pdx.menge_a                            ) from bde_pd_prod pdx where r.res_id = pdx.res_id
                                                                                         and pdx.vorg_typ  = 'PP'
                                                                                         and pdx.prod_ende >= (bde_funktionen.get_ausw_begin)
                                                                                         and pdx.prod_ende <=  (bde_funktionen.get_ausw_ende)), 0
            ) gm,
         nvl((select sum(              pdx.menge_b + pdx.schrott) from bde_pd_prod pdx where r.res_id = pdx.res_id
                                                                                         and pdx.vorg_typ  = 'PA'
                                                                                         and pdx.prod_ende >= (bde_funktionen.get_ausw_begin)
                                                                                         and pdx.prod_ende <=  (bde_funktionen.get_ausw_ende)), 0
            ) am,
