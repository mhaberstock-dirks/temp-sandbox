create table dirkspzm32.isi_res_lte_gen_list (
    ...
    transp_id            number(*, 0),
    job_nr               number(*, 0) not null enable,
    drucker_name         varchar2(255 char),
    lgr_ort              number(5, 0),
...
alter table dirkspzm32.isi_res_lte_gen_list
    add constraint pk_isi_res_lte_gen_list
        primary key ( lte_id,
                      job_nr,
                      res_id,
                      created_date )
